...
<!--Panel lateral-->
        <div id="logocategoria">Categoría: Cómics y revistas</div>
		<div id="body">
			<div class="inner">
                 <div class="leftbox">
...
<!-- / rightbox -->
				...
				<div class="leftbox">
					...
					<p>Autor: <b>Jeff Parker; Roger Cruz</b></p>
